export interface Translations {
  ...
  tips: {
    title: string;
    categories: { title: string; tips: string[] }[];
  };
  projectTemplate: {
    guideTitle: string;
    themeLabel: string;
...
export const nl: Translations = {
  ...
  videoPlanner: {
    ...
    steps: [
      ...
      { title: "2. Begin", points: ["Leg uit wat je gaat doen."] },
      {
        title: "3. Midden",
  ...
  tips: {
    ...
    categories: [
      ...
      { title: "Geluid", tips: ["Film op een rustige plek.", "Praat duidelijk.", "Controleer achtergrondgeluid."] },
      { title: "Presenteren", tips: ["Lach.", "Kijk in de camera.", "Praat rustig.", "Wees jezelf."] },
      {
        title: "Bewerken",
  ...
  projectTemplate: {
    ...
    imagesLabel: "Afbeeldingen-ideeën",
    ...
    buildupTitle: "Opbouw van je vlog",
    introLabel: "Intro",
...
export const en: Translations = {
  ...
  videoPlanner: {
    ...
    steps: [
      ...
      { title: "2. Beginning", points: ["Explain what you're going to do."] },
      {
        title: "3. Middle",
  ...
  tips: {
    ...
    categories: [
      ...
      { title: "Sound", tips: ["Film in a quiet place.", "Speak clearly.", "Check background noise."] },
      { title: "Presenting", tips: ["Smile.", "Look into the camera.", "Speak calmly.", "Be yourself."] },
      {
        title: "Editing",
  ...
  projectTemplate: {
    ...
    buildupTitle: "Structure of your vlog",
    introLabel: "Intro",
